...
import os
log_channel = int(os.environ.get('LOG_CHANNEL','-1001514100377'))
    ...
    if query.data.startswith("file"):
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  ...
                  InlineKeyboardButton('🔍 Search Again 🔍', switch_inline_query_current_chat='')
                  #InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/arunarudra")
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/arunarudra")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            if not files:
                ...
                await message.reply_text(text=f"△ 𝙷𝚎𝚢 {message.from_user.first_name} 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ ᴛᴏ ᴏᴜʀ ᴀᴅᴍɪɴ'ꜱ!\n ᴘʟᴇᴀꜱᴇ ᴋᴇᴇᴘ ꜱᴏᴍᴇ ᴘᴀᴛɪᴇɴᴄᴇ!\n ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ.\n\n📝𝘾𝙤𝙣𝙩𝙚𝙣𝙩 𝙣𝙖𝙢𝙚 : {search}\n👮𝙍𝙚𝙦𝙪𝙚𝙨𝙩𝙚𝙙 𝘽𝙮 : {message.from_user.first_name}\n\n",
                                                                                                     reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("━ • │▌║  Add me to your Group  ║▌│ • ━", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("╚»♥️Thank you™♥️«╝", callback_data="close_data"), InlineKeyboardButton('🔍 Search Again 🔍', switch_inline_query_current_chat='')]]))
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            if message.chat.id == SUPPORT_CHAT_ID:
                ...
                pic = imdb.get('poster')
                poster = pic.replace("._V1_UX360.jpg", '.jpg')
